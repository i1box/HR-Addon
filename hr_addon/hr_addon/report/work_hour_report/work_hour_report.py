...
def get_columns():
	return [		
		...
		{'fieldname':'status','label':'Status', "width": 110},
		{'fieldname':'total_target_seconds','label':_('Target H.'), "width": 90, },
		#{'fieldname':'total_work_seconds','label':_('Work Hours'), "width": 90, },
		{'fieldname':'actual_working_seconds','label':_('Act. Work H.'), "width": 110, },
		...
		{'fieldname':'actual_diff_log','label':'Act. Work H. - Target H.','width':90},
